			...
			<div className="bg-gradient-to-br from-orange-500 via-red-500 to-pink-500 text-white">
				...
				<section className="flex flex-col items-center justify-center text-center py-20 px-6">
					...
					<p className="text-lg md:text-xl max-w-2xl mb-8">
						Swipe. Match. Collaborate. The fastest way for
						developers to find teammates, mentors, and projects.
					</p>
					...
					<div className="grid gap-8 md:grid-cols-3">
						<div className="card bg-orange-100 shadow-lg rounded-2xl">
							<div className="card-body items-center text-center">
								...
								<p>
									Find developers near you who share your
									passion.
								</p>
							</div>
						</div>
						<div className="card bg-red-100 shadow-lg rounded-2xl">
							<div className="card-body items-center text-center">
								...
								<p>
									Swipe through profiles and match instantly
									with like-minded devs.
								</p>
							</div>
						</div>
						<div className="card bg-pink-100 shadow-lg rounded-2xl">
							<div className="card-body items-center text-center">
								...
								<p>
									Start building the next big idea together
									today.
								</p>
							</div>
						</div>
